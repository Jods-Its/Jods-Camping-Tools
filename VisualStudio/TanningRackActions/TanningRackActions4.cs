...
{
    internal class TanningRackActions4 : IExamineAction, IExamineActionProduceItems, IExamineActionRequireItems
    {
        public TanningRackActions4() { }
        IExamineActionPanel? IExamineAction.CustomPanel => null;

        string IExamineAction.Id => nameof(TanningRackActions4);

        string IExamineAction.MenuItemLocalizationKey => "GAMEPLAY_CT_TRackMoose";
        ...
        {
            items.Add(new("GEAR_MooseHide", 1, 100));
        }
        ...
        void IExamineActionProduceItems.GetProducts(ExamineActionState state, List<MaterialOrProductItemConf> products)
        {
            ...
            {
                0 => new("GEAR_TanningRackMP2", 1, 100),
            });
        }
